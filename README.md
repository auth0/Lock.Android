...
If you'll create your own API and just call Auth0 API via the `com.auth0.android:core:1.5.+`, the minimum required API level is 9.
...
```gradle
compile 'com.auth0.android:lock-sms:1.5.+'
```
